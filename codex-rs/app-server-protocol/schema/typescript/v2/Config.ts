...
export type Config = {model: string | null, review_model: string | null, review_provider: string | null, compact_model: string | null, compact_provider: string | null, model_context_window: bigint | null, model_auto_compact_token_limit: bigint | null, model_provider: string | null, approval_policy: AskForApproval | null, /**
